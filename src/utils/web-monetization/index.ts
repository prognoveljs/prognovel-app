...
import { isCurrentChapterMonetized } from "store/read-page";
import { currentNovel, novelsData, siteMetadata } from "store/states";
import {
...
export function webMonetizationInit(): void {
  ...
  function runWebMonetization(): void {
    ...
    if (!((process as any).browser && monetization)) return;
