...
<div class="container-center">
  <h1>Privacy Policy for ProgNovel (WIP)</h1>
  <p>
    At ProgNovel, accessible from https://www.prognovel.com, one of our main priorities is the
    privacy of our visitors. This Privacy Policy document contains types of information that is
    collected and recorded by ProgNovel and how we use it.
  </p>
  <p>
  ...
  <h3>Log Files</h3>
  <p>
    ProgNovel follows a standard procedure of using log files. These files log visitors when they
  ...
  <p>
    Like any other website, ProgNovel uses 'cookies'. These cookies are used to store information
  ...
  <p>
    ...
    ProgNovel. Our Privacy Policy was created with the help of the Privacy Policy Generator and the
    Privacy Policy Generator Online.
  </p>
  <p>
    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
    that are used in their respective advertisements and links that appear on ProgNovel, which are
  ...
  <p>
    Note that ProgNovel has no access to or control over these cookies that are used by third-party
    advertisers.
  </p>

  <h3>Third Party Privacy Policies</h3>
  <p>
    ProgNovel's Privacy Policy does not apply to other advertisers or websites. Thus, we are
  ...
  <p>
    ProgNovel does not knowingly collect any Personal Identifiable Information from children under
  ...
  <p>
    ...
    website with regards to the information that they shared and/or collect in ProgNovel. This
