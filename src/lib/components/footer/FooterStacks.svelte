...
<a href="https://community.interledger.org/prognovel" aria-label="GftW">
...
<style lang="scss">
  ...
  h3 {
    ...
    font-size: 1.4rem;
    font-weight: 700;
    color: hsl(var(--primary-color-h), 72%, 55%);
  ...
  a {
    ...
    &:hover {
      ...
      box-shadow: 0 6px 18px #0001, 0 4px 8px #0002;
      border-color: hsla(
        var(--primary-color-h),
        var(--primary-color-s),
        var(--primary-color-l),
      ...
      h3 {
        color: hsl(var(--primary-color-h), 76%, 61%);
      }
    ...
    :global(html.light) & {
      img.logo {
        filter: contrast(0.85) grayscale(0) !important;
      }
