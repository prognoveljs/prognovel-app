...
const ecommerce = {
   ...
   **/,
  selectPromotion: function eventName(
    items,
    promotion_id,
    promotion_name,
    creative_name,
   ...
   **/,
  viewPromotion: function eventName(
    items,
    promotion_id,
    promotion_name,
    creative_name,
...
export { addEvent, all, ecommerce, retail, travel, games, setUserProperties };
