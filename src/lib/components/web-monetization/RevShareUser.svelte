<script lang="ts">
  import ProgressCircle from "$lib/components/misc/ProgressCircle.svelte";
  import { revShareStats } from "$lib/utils/web-monetization";
  import { getGravatarURL } from "$lib/utils/users";
  import { revShareDetails } from "./_shared";
  import { getUser } from "$lib/utils/users/avatar";
