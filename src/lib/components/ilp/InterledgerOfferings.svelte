...
{#if show}
  <div class="ilp-container" style="opacity: {containerDisplay};">
    <article style="background: {background};">
      ...
      <section class="options">
        <Option on:picked={pickOffer} price="$0.29/week" selected iswebmonetization
          >+2 chapter</Option
        >
    ...
    <small
      >powered by
      <img
        src="/img/svg/open-payments/logomark.svg"
        width="18px"
        height="18px"
        alt="Open Payments"
      />
  ...
  >
    We're currently exploring the possibility of sending payments and micro-tippings through
    Interledger. In the meantime, please enjoy premium features with Web Monetization.
  </Modal>
{/if}
