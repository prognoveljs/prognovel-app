declare module "js-coroutines" {
  class TerminatablePromise<T> extends Promise<T> {
  ...
  function forEach(collection: any, fn: Function): Generator<any, any, any>;

  /**
   * @returns array of elements matching the filter
   */
  function filter(collection: any, fn: Function): Generator<any, any, any>;

  /**
   * @returns The result of processing the reduction function on all
   * of the items in the array
   */
  function reduce(collection: any, fn: Function, initialValue?: any): Generator<any, any, any>;

  /**
   * Concatenate two arrays into a new array
   * @returns the concatenated arrays
   */
  function concat(array1: any[], array2: any[]): Generator<any, any[], any>;
   ...
   */
  function append(array1: any[], array2: any[]): Generator<any, any[], any>;

  /**
   * @returns new array of mapped values
   */
  function map(collection: any, fn: Function): Generator<any, any[], any>;

  /**
   * @returns the first matching value in the array or null
   */
  function find(collection: any, fn: Function): Generator<any, any, any>;

  /**
   * @returns Index of matching element or -1
   */
  function findIndex(array: any[], fn: Function): Generator<any, number, any>;

  /**
   * @returns true if at least one item matched the filter
   */
  function some(array: any[], fn: Function): boolean;

  /**
   * @returns true if all of the array items matched the filter
   */
  function every(array: any[], fn: Function): boolean;
   ...
   */
  function stringifyAsync(data: any): TerminatablePromise<String>;
   ...
   */
  function parseAsync(json: string): TerminatablePromise<any>;
   ...
   * @returns {Generator<*, [], *>}
   */
  function uniqueBy(array: [], fn: Function): Generator<any, [], any>;
   ...
   */
  function groupBy(collection: [] | {}, fn: Function): Generator<any, {}, any>;
   ...
   * @returns {Generator<*, {}, *>} a generator for the new object
   */
  function keyBy(collection: [] | {}, fn: Function): Generator<any, {}, any>;
   ...
   */
  function lastIndexOf(array: [], value: any): Generator<any, number, any>;
   ...
   */
  function indexOf(array: [], value: any): Generator<any, number, any>;
   ...
   */
  function includes(array: [], value: any): Generator<any, boolean, any>;
   ...
   * @returns {Promise<[]>}
   */
  function uniqueByAsync(array: [], fn: Function): TerminatablePromise<[]>;
   ...
   */
  function groupByAsync(collection: [] | {}, fn: Function): TerminatablePromise<{}>;
   ...
   * @returns {Promise<{}>} a generator for the new object
   */
  function keyByAsync(collection: [] | {}, fn: Function): TerminatablePromise<{}>;
   ...
   */
  function lastIndexOf(array: [], value: any): TerminatablePromise<Number>;
   ...
   */
  function indexOf(array: [], value: any): TerminatablePromise<number>;
   ...
   */
  function includes(array: [], value: any): TerminatablePromise<Boolean>;
   ...
   */
  function sortAsync(array: any[], sort: Function): TerminatablePromise<any[]>;
   ...
   */
  function findAsync(collection: [] | {}, filter: Function): TerminatablePromise<any | null>;
   ...
   */
  function findIndexAsync(collection: [] | {}, filter: Function): TerminatablePromise<Number>;
   ...
   */
  function mapAsync(collection: [] | {}, mapFn: Function): TerminatablePromise<[] | {}>;

  /**
   * Functions an array asynchronously
   * @returns promise for the filtered array
   * @example
   * const errorJobs = await filterAsync(jobs, job => !!job.error)
   */
  function filterAsync(collection: [] | {}, filter: Function): TerminatablePromise<[] | {}>;
   ...
   */
  function someAsync(array: any[], fn: Function): TerminatablePromise<Boolean>;
   ...
   */
  function everyAsync(array: any[], fn: Function): TerminatablePromise<Boolean>;
   ...
   */
  function compressToBase64Async(source: string): TerminatablePromise<String>;
   ...
   */
  function compressToUTF16Async(source: string): TerminatablePromise<String>;
   ...
   */
  function compressToUint8ArrayAsync(source: string): TerminatablePromise<Uint8Array>;
   ...
   */
  function compressToEncodedURIComponentAsync(source: string): TerminatablePromise<String>;
   ...
   */
  function compressAsync(source: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the compressed data
   */
  function base64CompressToUTF16Async(source: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the compressed data
   */
  function base64CompressAsync(source: string): TerminatablePromise<String>;
   ...
   */
  function decompressFromUTF16Async(compressedData: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the uncompressed data
   */
  function decompressFromUint8ArrayAsync(compressedData: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the uncompressed data
   */
  function decompressAsync(compressedData: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the uncompressed data
   */
  function base64decompressFromUTF16Async(base64Data: string): TerminatablePromise<String>;
   ...
   * @returns a promise for the uncompressed data
   */
  function base64Decompress(base64Data: string): TerminatablePromise<String>;
   ...
   */
  function run(
    coroutine: Function | Generator,
    loopWhileMsRemains?: number,
    timeout?: number,
  ): TerminatablePromise<any>;
   ...
   */
  function update(coroutine: Function | Generator, ...params: any[]): TerminatablePromise<any>;
   ...
   */
  function wrapAsPromise(coroutine: () => Generator): Function;

  function pipe(...functions: Array<Function> | Array<Array<Function>>): any;
  function tap(fn: Function): Function;
  function branch(fn: Function): Function;
  function repeat(fn: Function, times: Number): Function;
  function call(fn: Function, ...parameters: any[]): Function;
   ...
   */
  function useInternalEngine(internal: Boolean): void;
   ...
   */
  function singleton(fn: Function, defaultValue?: any): ChainableFunction;
}
